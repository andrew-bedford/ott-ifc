...
\lstset{
    backgroundcolor=\color{jblue!10},   	% choose the background color; you must add \usepackage{color} or \usepackage{xcolor}
    basicstyle=\tt\small\color{gray!125},       			% the size of the fonts that are used for the code
    ...
    morekeywords={Lemma, Proof, Qed, if, then, else, end, skip},            % if you want to add more keywords to the set
